  ...
  return (
    ...
    <div class="container px-6 py-40 mx-auto text-center">
        <div class="max-w-lg mx-auto">
            ...
            <p class="mt-6 text-gray-500 dark:text-gray-300">Scan any product's barcode and get detailed information about the product including name, ingredients, labels, and image..</p>
