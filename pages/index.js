  ...
  return (
    ...
    <div class="container px-6 py-40 mx-auto text-center">
        <div class="max-w-lg mx-auto">
            <h1 class="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">Food facts  </h1>
            <p className="mt-6 text-gray-500 dark:text-gray-300">Scan any products barcode and get detailed information about the product including name, ingredients, labels, and image..</p>
            < Link href="/scan">
